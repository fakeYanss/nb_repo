...
To run the [test suite](/xwmx/nb/blob/master/test), install [Bats](https://github.com/bats-core/bats-core) and the [recommended dependencies](#optional), then run `bats test` in the project root.
